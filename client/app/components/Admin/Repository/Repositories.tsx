...
const Repositories = (props: Props) => {
  ...
  const [removeRepo, { isSuccess, error }] = useRemoveRepoMutation({});
  const columns = [
    { field: 'id', headerName: 'ID', flex: 0.5 },
    { field: 'title', headerName: 'Repo Title', flex: 1 },
    { field: 'url', headerName: 'Repo URL', flex: 0.5 },
