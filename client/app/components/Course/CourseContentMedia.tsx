  ...
  return (
    <div className='min-h-[40vh]'>
      {links.map((item, index: number) => (
        <div className='mb-5 overflow-hidden' key={index}>
          <h2 className='800px:text-[20px] 800px:inline-block dark:text-white text-black'>
            {item.title && item.title + ' :'}
          </h2>
          <a
            // className='inline-block text-[#4395c4] 800px:text-[20px] 800px:pl-2'
            className='truncate overflow-hidden text-clip text-[#4395c4] 800px:text-[18px] 800px:pl-2'
            href={item.url}
            target='_blank'
            title={item.url}
          >
...
const CourseContentMedia = ({
  ...
  console.log(data, course?.sections, 'data is in best');

  return (
    <div className='w-[95%] 800px:w-[86%] py-4 m-auto'>
      {/* {data[activeVideo].videoUrl.includes('http') ? ( */}
      <CoursePlayer
      ...
      //     <Resources links={data[activeVideo]?.links} />
      //   </div>
      // )} */}
      ...
      <br />
      <div className='w-full py-2 flex items-center gap-8'>
        {['Overview', 'Resources', 'Q&A', 'Reviews'].map((text, index) => (
          <h5
            key={index}
            className={`800px:text-[18px] cursor-pointer pb-2 ${
              activeBar === index
                ? 'text-[#37a39a] border-b-2 border-[#37a39a] font-semibold'
      ...
      <div className='min-h-[400px]'>
        ...
        {activeBar === 1 && <Resources links={data[activeVideo]?.links} />}
          ...
          <>
            ...
            <>
              <div className='w-full flex relative dark:text-white text-black'>
                ...
                >
                  {answerCreationLoading ? 'Loading...' : 'Submit'}
                </button>
              </div>
              <br />
            </>
