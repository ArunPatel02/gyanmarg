export const styles = {
    ...
    button:"flex flex-row justify-center items-center py-3 px-6 rounded-lg shadow-lg text-white cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] font-Poppins font-medium hover:opacity-90"
}