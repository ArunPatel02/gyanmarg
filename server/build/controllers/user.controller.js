...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        console.log(__dirname, path_1.default.join(__dirname, '../mails/activation-mail.ejs'));
        fs_1.default.access('../mails/activation-mail.ejs', fs_1.default.constants.F_OK, (err) => {
            if (err) {
