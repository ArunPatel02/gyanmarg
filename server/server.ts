...
let data = {
  ...
  thumbnail:
    'https://res.cloudinary.com/dwjjmwc1v/image/upload/v1703181070/courses/hpps2g1ui2csbpy43jlb.png',
  level: 'Expert',
  ...
  courseData: [
    {
      ...
      description:
        'The course stands out for its emphasis on project-based learning, where students actively engage in developing three projects. This hands-on approach allows them to apply theoretical knowledge in practical scenarios, deepening their understanding and preparing them for real-world challenges. Beyond individual projects, students build a portfolio showcasing their ability to create end-to-end applications, making them competitive candidates in the job market. The continuous learning pathway from basics to advanced levels establishes a strong foundation, enabling students to adapt to evolving technologies in the dynamic field of software development.',
